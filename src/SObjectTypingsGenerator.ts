...
export default class SObjectTypingsGenerator {
	async generateSObjectTypings(sObjectDescribe:DescribeSObjectResult, typingsFolder:string) {
		let typings =
		...
		typings += "{\n" + this.generateTypingForChildRelationships(sObjectDescribe.childRelationships);
	...
	generateTypingForChildRelationships(relationships:ChildRelationship[]):string {
		let typings = ""
	...
	generateTypingsForField(sObjectDescribe: DescribeSObjectResult, field:Field) :string{
	...
	generateTypingsForReferenceField(sObjectDescribe:DescribeSObjectResult, field:Field):string {
